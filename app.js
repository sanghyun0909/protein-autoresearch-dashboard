 ...
 *   {id, parent, operator, family, status, composite, ec, go, repsp, flip,
 *    kept, pareto, tokens, runtime_s}
 * anchor = pretrained ESM-2 35M composite (0.590); nodes ordered by id ("trial").
 */
"use strict";
...
const METRICS = {
  composite: { label: "composite (mean EC/GO/RepSP)", key: "composite", anchored: true },
  ec: { label: "EC Fmax", key: "ec", anchored: false },
  go: { label: "GO Fmax", key: "go", anchored: false },
  repsp: { label: "RepSP AUPRC", key: "repsp", anchored: false },
  flip: { label: "FLIP Spearman (noise — excluded from composite)", key: "flip", anchored: false },
};
